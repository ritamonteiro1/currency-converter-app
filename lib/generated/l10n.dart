...
class S {
  ...
  /// `Currency converter`
  String get homeScreenCurrencyConverterText {
    return Intl.message(
      'Currency converter',
      name: 'homeScreenCurrencyConverterText',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Reais`
  String get homeScreenRealLabelTextField {
    return Intl.message(
      'Reais',
      name: 'homeScreenRealLabelTextField',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Dollars`
  String get homeScreenDollarsLabelTextField {
    return Intl.message(
      'Dollars',
      name: 'homeScreenDollarsLabelTextField',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Euros`
  String get homeScreenEurosLabelTextField {
    return Intl.message(
      'Euros',
      name: 'homeScreenEurosLabelTextField',
      desc: '',
      args: [],
    );
  }
